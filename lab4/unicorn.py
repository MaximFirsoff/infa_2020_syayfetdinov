...
def mane():
    ellipse(screen, dandelion_yellow, (417, 298, 47, 25))
    ellipse(screen, dandelion_yellow, (405, 327, 35, 107))
    ...
    arc(screen, dandelion_yellow, (437, 321, 20, 50), 4.5*pi/10, 14*pi/10, 6)
    ...
    arc(screen, dandelion_yellow, (448, 310, 56, 26), 0.35 * pi, 1 * pi, 7)
...
def tail():
    ellipse(screen, dandelion_yellow, (280, 443, 40, 25))
    ...
    arc(screen, dandelion_yellow, (276, 456, 38, 134), 0.6 * pi, 1.1 * pi, 9)
